    ...
    <div class="container">
        ...
        <div class="navbar-brand">
            ...
            <a class="navbar-item is-brand mx-4" href="index.html">
                <img class="light-image" src="{{ asset('modules/home/assets/img/logos/logo/logo.svg') }}" alt="">
                <img class="dark-image" src="{{ asset('modules/home/assets/img/logos/logo/logo-light.svg') }}" alt="">
            </a>
        </div>
    </div>
</nav>
        ...
        <div class="center">
            @auth
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        @else
                            <a class="is-danger is-outlined tag text-danger title" href="{{ route('academic.setting') }}" tabindex="-1" aria-disabled="true"><i class="bi bi-exclamation-diamond-fill me-2"></i> Create an Academic Session.</a>
                        @endif
                    </li>
                </ul>
            @endauth
            <div id="webapp-navbar-menu" class="centered-drops">
                <div class="centered-drop">
                    <div class="dropdown ُ">
                        <div class="is-trigger" aria-haspopup="true">
                            <a href="{{ route('home') }}" class="button h-button is-rounded" aria-haspopup="true">
                            ...
                            <div class="dropdown-content">
                                ...
                                <div class="category-selector">
                                    ...
                                    <div class="category-selector-inner">
                                        ...
                                        <img class="placeholder-image light-image" src="{{ asset('modules/home//assets/img/illustrations/components/buttons.svg') }}" alt="" />
                                        <img class="placeholder-image dark-image" src="{{ asset('modules/home//assets/img/illustrations/components/buttons-dark.svg') }}" alt="" />
                                    </div>
                                </div>
                ...
                <div class="centered-drop">
                    <div class="dropdown">
                        <div class="is-trigger" aria-haspopup="true">
                            <a href="{{ route('academic.setting') }}" class="button h-button is-rounded" aria-haspopup="true">
                                <span>Academic</span>
                            </a>
                        </div>
                    </div>
    ...
    <div class="right-panel">
        ...
        <div class="right-panel-body has-slimscroll">
            <div class="languages-boxes">
                ...
                <div class="language-box">
                    <div class="language-option">
                        ...
                        <div class="language-option-inner">
                            <img src="{{ asset('modules/home/assets/img/icons/flags/france.svg') }}" alt="">
                            <div class="indicator">
                                <i data-feather="check"></i>
                            </div>
                        </div>
                ...
                <div class="language-box">
                    <div class="language-option">
                        <input type="radio" name="language_selection">
                        <div class="language-option-inner">
                            <img src="{{ asset('modules/home/assets/img/icons/flags/spain.svg') }}" alt="">
                            <div class="indicator">
                                <i data-feather="check"></i>
                            </div>
                        </div>
                ...
                <div class="language-box">
                    <div class="language-option">
                        <input type="radio" name="language_selection">
                        <div class="language-option-inner">
                            <img src="{{ asset('modules/home/assets/img/icons/flags/germany.svg') }}" alt="">
                            <div class="indicator">
                                <i data-feather="check"></i>
                            </div>
                        </div>
                ...
                <div class="language-box">
                    <div class="language-option">
                        <input type="radio" name="language_selection">
                        <div class="language-option-inner">
                            <img src="{{ asset('modules/home/assets/img/icons/flags/mexico.svg') }}" alt="">
                            <div class="indicator">
                                <i data-feather="check"></i>
                            </div>
                        </div>
                ...
                <div class="language-box">
                    <div class="language-option">
                        <input type="radio" name="language_selection">
                        <div class="language-option-inner">
                            <img src="{{ asset('modules/home/assets/img/icons/flags/china.svg') }}" alt="">
                            <div class="indicator">
                                <i data-feather="check"></i>
                            </div>
                        </div>
            ...
            <div class="img-wrap has-text-centered">
                <img class="light-image" src="{{ asset('modules/home/assets/img/illustrations/right-panel/languages.svg') }}" alt="">
                <img class="dark-image" src="{{ asset('modules/home/assets/img/illustrations/right-panel/languages-dark.svg') }}" alt="">
            </div>
        </div>
    </div>
</div>
